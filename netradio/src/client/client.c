...
int main(int argc, char *argv[])
{
	...
	int index = 0;
	struct option argarr[5] = {{"mgroup", 1, NULL, 'P'}, {"port", 1, NULL, 'M'}, {"player", 1, NULL, 'p'}, {"help", 1, NULL, 'H'}, {NULL, 0, NULL, 0}};
	...
	//设置socket多播回环（多播数据包会同时被发送给接收者和发送者自己）
	//启用回环可以使得本机发送的多播包也能被本机接收
	int val = 1;
